        ...
        @if($regions->count() > 0)
            ...
            <table class="table datatable-button-html5-columns">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $i++ }}</td>
                        <td><a href="{{route('regions.show', $region->id)}}">{{ $region->name }}</a></td>
                        <td>
                            @if($region->status == 0) <span class="badge bg-warning">Inactive</span>
                                @elseif($region->status == 1) <span class="badge bg-success">Active</span>
                            @endif
                        </td>
                        <td>{{ $region->details ?? '' }}</td>
                            ...
                            <div class="d-inline-flex">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="{{route('regions.show', $region->id)}}" class="dropdown-item">
