            ...
            <div class="card-body">
                @if ($errors->any())
                    <div class="alert alert-danger alert-icon-start alert-dismissible fade show">
                        ...
                        <span class="fw-semibold">Team details could not be saved, please check the errors below and try again!</span>
                ...
                <form action="{{route('teams.store')}}" method="post">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Team Name">
                                        @error('name')
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea id="details" rows="5" class="form-control summernote @error('details') is-invalid @enderror" name="details" value="{{ old('details') }}" placeholder="Team Description">{{ old('details') }}</textarea>
                                        @error('details')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary ms-3">Create Team <i class="ph-paper-plane-tilt ms-2"></i></button>
                        </div>
                </form>
            </div>
        </div>
